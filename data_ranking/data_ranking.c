...
char school[9] short int class char name[9] char sex char exam_num c
har chinese char math char english char physics char chemistry
char life char politics char history char geography
short int score_sum short int position_county
short int position_school short int position_class
成绩排序
*/
